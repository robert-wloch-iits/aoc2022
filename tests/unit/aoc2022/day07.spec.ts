...
describe('day07', () => {
  ...
  describe('sumDirectorySizes', () => {
    it('gets a file system tree and sums all directory sizes up to 100000 and returns 95437', () => {
      ...
      const result = sumDirectorySizes(input, (size) => size <= 100000 ? size : 0)
      expect(result).toBe(95437)
    })
  })

  describe('solves puzzle #1', () => {
    it('gets shell history of the puzzle as input and returns the sum of directory sizes up to size 100000', () => {
